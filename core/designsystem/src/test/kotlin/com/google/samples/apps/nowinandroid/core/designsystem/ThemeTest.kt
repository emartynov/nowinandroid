...
class ThemeTestContent : RobolectricTestSuiteContent({
    testFixture {
        ...
        test("dark theme false dynamic color false android theme false") {
        ...
        test("dark theme true dynamic color false android theme false") {
            composeTestRule.setContent {
                NiaTheme(
                    darkTheme = true,
                    disableDynamicTheming = true,
        ...
        test("dark theme false dynamic color true android theme false") {
            composeTestRule.setContent {
                NiaTheme(
                    darkTheme = false,
        ...
        test("dark theme true dynamic color true android theme false") {
            composeTestRule.setContent {
                NiaTheme(
                    darkTheme = true,
                    disableDynamicTheming = false,
        ...
        test("dark theme false dynamic color false android theme true") {
            composeTestRule.setContent {
                NiaTheme(
                    darkTheme = false,
                    disableDynamicTheming = true,
        ...
        test("dark theme true dynamic color false android theme true") {
            composeTestRule.setContent {
                NiaTheme(
                    darkTheme = true,
                    disableDynamicTheming = true,
        ...
        test("dark theme false dynamic color true android theme true") {
            composeTestRule.setContent {
                NiaTheme(
                    darkTheme = false,
                    disableDynamicTheming = false,
        ...
        test("dark theme true dynamic color true android theme true") {
            composeTestRule.setContent {
                NiaTheme(
                    darkTheme = true,
                    disableDynamicTheming = false,
